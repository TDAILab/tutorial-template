...
#ここの配置は何とかする必要がある
   ...
   ・ Status is Pending : The program is executed at present.//listnum
   ・ Status is Success : The program is done and you can see the result on AWS website. Refer to the following for the way.//listnum
   ・ Status is Failed : The program is failed because of some reasons. You can investigate a cause to see the "pipeline" page in the AWS site. //listnum
